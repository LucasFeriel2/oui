      ...
      <div className='absolute left-0 top-0 w-full h-full overflow-x-auto ' style={{background:"#D9D9D9"}}>
        <div className='absolute left-0 top-28 w-full h-24 flex justify-between pl-12 pr-12'>
          <div>
            ...
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
          </div>
          <div>
        ...
        <div className='absolute left-0 top-48 w-full h-32 flex justify-between pl-12 pr-12'>
            <div>
              ...
              <input className='top-10 w-50 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
              <input className='top-20 w-50 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            </div>
            <div>
        ...
        <div className='absolute left-0 top-80 w-full h-44 flex justify-between pl-12 pr-12'>
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'>max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
          </div>
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'>max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input>
          </div>
          <div>
            {/* <label className='top-2 text-black'>CDF</label><br></br> */}
            <img src='https://cdn-icons.flaticon.com/png/512/922/premium/922869.png?token=exp=1657698329~hmac=c4253ad24950d1cb26ac33951e21d9be' className='w-16 '></img>
            <label className=' top-2 text-black'>actuel</label><br></br>
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'> max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input>
          ...
          <div>
            ...
            <img src='https://cdn-icons.flaticon.com/png/512/1818/premium/1818176.png?token=exp=1657698439~hmac=6d73c6017a341f34cbbcf00d251dbd68' className='w-16 '></img>
            <label className=' top-2 text-black'>actuel</label><br></br>
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'> max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input>
          ...
          <div>
            ...
            <img src='https://cdn-icons.flaticon.com/png/512/4578/premium/4578785.png?token=exp=1657700481~hmac=adf251d2fae87030d7acd452cdbe4f75' className='w-16 '></img>
            <label className=' top-2 text-black'>actuel</label><br></br>
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'>max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input>
          ...
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-2 text-blue-500 text-center'></input>
          </div>
          <div>
        ...
        <div className='absolute left-0 top-[600px] w-full flex justify-between pl-12 pr-12  '>
          <div className='w-44'>
            ...
            <input className=' top-10 w-16 h-16 bg-transparent border-black border-4 text-blue-500 text-center'></input>
          </div>
          <div className='w-44'>
        ...
        <div className='absolute left-0 top-[1650px] w-full'>
          <div className='absolute left-0  w-full h-24 flex justify-between pl-12 pr-12'>
            <div>
              ...
              <input className='top-10 w-52 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            </div>
            <div>
              <label className='top-4 text-black'>Surnom</label><br></br>
              <input className='top-10 w-52 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
        ...
        <div className='absolute left-0 top-[1850px] w-full'>
          <div className='absolute left-0  w-full h-24 flex justify-between pl-12 pr-12'>
            ...
            <div>
              ...
              <input className='top-10 w-44 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
              <input className='top-10 w-44 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            </div>
            <div>
        ...
        <div className='absolute left-0 top-[2050px] w-1/2 h-24'>
            <label className=' text-black'>Nom</label><input className='top-10 w-44 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className=' text-black'>Dégâts</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className=' text-black'>Violence</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className='text-black'>Portée</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className=' text-black'>Énergie</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <label className=' text-black'>Dégâts</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className=' text-black'>Activation</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className='text-black'>Durée</label><input className='top-10 w-24 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
            <label className='text-black'>Évolution</label><input className='top-10 w-44 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <label className='text-black'>Effet</label><input className='top-10 w-3/4 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input>
        </div>
        ...
        <div className='absolute left-0 top-[2250px] w-full h-24 flex justify-between pl-12 pr-12'>
          ...
          <div>
          <input className=' top-10 w-8 h-8 bg-transparent text-blue-500 text-center'></input>/<input className=' top-10 w-8 h-8 bg-transparent text-blue-500 text-center'></input>
          </div>
          <div>
        ...
        <div className='absolute left-0 top-[2350px] w-full h-24 flex justify-between pl-12 pr-12'>
          <div>
            ...
            <input className='top-10 w-64 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-64 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-64 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-64 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-64 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
          ...
          <div>
            ...
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-40 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
          ...
          <div>
            ...
            <input className='top-10 w-96 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-96 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-96 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-96 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
            <input className='top-10 w-96 bg-transparent border-transparent border-b-black border-4 text-blue-500 text-center'></input><br></br>
