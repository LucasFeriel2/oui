      ...
      <div className='absolute left-0 top-0 w-full h-full overflow-x-auto ' style={{background:"#D9D9D9"}}>
        ...
        <div className='absolute left-0 top-80 w-full h-44 flex justify-between pl-12 pr-12'>
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-4 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'>max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-4 text-blue-500 text-center'></input><br></br>
          </div>
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-4 text-blue-500 text-center'></input><br></br>
            <label className=' top-20 text-black'>max</label><br></br>
            <input className=' top-28 w-12 h-12 bg-transparent border-black border-4 text-blue-500 text-center'></input>
          </div>
          <div>
          ...
          <div>
            ...
            <input className=' top-10 w-12 h-12 bg-transparent border-black border-4 text-blue-500 text-center'></input>
          </div>
          <div>
        ...
        <div className='absolute left-0 top-[530px] w-full h-44 bg-black h-8 '>
