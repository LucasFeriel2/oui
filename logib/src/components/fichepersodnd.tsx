  ...
  return (
    <div className="App">
      <div className='absolute left-0 top-0 w-full h-full overflow-x-auto ' style={{ background: "#D9D9D9" }}>
        <div className='rounded-l-lg absolute border-double border-black border-4 left-[640px] top-28 w-80 h-24 '>
          <label className=''>Nom du Personnage</label><br></br>
          <input type="text" className='bg-transparent w-full h-16 text-2xl'></input>
        </div>
        <div className='rounded-l-lg absolute border-double border-black border-4  left-[960px] top-28 w-auto h-48 flex justify-between'>
          <div>
        ...
        <div className='rounded-lg absolute border-double bg-gray-400 border-black border-4 left-[96px] top-52 w-40 h-auto pt-3 flex flex-col justify-between'>
          <div>
        ...
        <div className=' rounded-lg absolute border-solid border-black border-4  left-[640px] top-56 w-72 h-16'>
          <input className='rounded-full border-black border-4 border-solid w-20 h-20 -left-4 absolute -top-3 text-center '></input>
          <label className='top-3  w-44 absolute left-16 text-xl '>Bonus de maîtrise</label>
        </div>
        <div className=' rounded-lg absolute border-solid border-black border-4 left-[640px] top-[310px]  w-72 h-16'>
          <input className='rounded-full border-black border-4 border-solid w-20 h-20 -left-4 absolute -top-3 text-center '></input>
          <label className='top-3 w-44 absolute left-16 text-xl '>Perception Passive</label>
        </div>
        <div className=' rounded-lg absolute border-solid border-black border-4 left-[282px] top-[400px] top-52 w-72 h-auto pt-3 pb-3 pl-3 pr-3 flex flex-col justify-between text-left'>
          <div>
        ...
        <div className=' rounded-lg absolute border-solid border-black border-4 left-[282px] top-[500px] w-72 h-auto pt-3 pb-3 pl-3 pr-3 flex flex-col justify-between text-left'>
          <div>
            <input type="text" className='bg-transparent w-12 h-8 text-2xl border-transparent border-b-black border-4 text-center text-center '></input>
        ...
        <div className='rounded-lg absolute border-double bg-gray-400 border-black border-4 left-[640px] top-[400px] w-auto h-96 pt-3 pl-5 pr-5 '>
        ...
        <div className='rounded-lg absolute border-double bg-gray-400 border-black border-4 left-[1300px] top-[400px] w-auto h-auto pt-3 pl-5 pr-5 '>
          <div className='rounded-t-lg bg-white border-solid border-4 h-auto w-full'>
        ...
        <div className='absolute border-black border-4 left-[640px] top-[800px] w-auto h-96 pt-3 pl-5 pr-5  '>
          <div className='flex justify-between'>
            <div>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[1200px] top-[1100px] w-auto h-auto pt-3 pl-5 pr-5 '>
          <input className='bg-transparent w-96 h-8 text-2xl border-transparent border-b-black border-2  '></input><br></br>
          <input className='bg-transparent w-96 h-8 text-2xl border-transparent border-b-black border-2  '></input><br></br>
          <input className='bg-transparent w-96 h-8 text-2xl border-transparent border-b-black border-2  '></input><br></br>
          <input className='bg-transparent w-96 h-8 text-2xl border-transparent border-b-black border-2  '></input><br></br>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[96px] top-[1200px] w-[480px] h-[650px] pt-3 pl-5 pr-5 '>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[640px] top-[1200px] w-[515px] h-[650px] pt-3 pl-5 pr-5 '>
          <div className=' flex justify-between'>
            <div>
        ...
        <div className='rounded-lg absolute border-double bg-gray-400 border-black border-4 left-[500px] top-[1900px] w-auto h-auto pt-3 pl-5 pr-5 flex justify-between '>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[96px] top-[2100px] w-auto h-auto pt-3 pl-5 pr-5 '>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[650px] top-[2100px] w-auto h-auto pt-3 pl-5 pr-5 '>
          <div className='-left-0 rounded-lg absolute border-solid border-black border-4 bg-gray-400   w-full h-12'>
        ...
        <div className='rounded-lg absolute border-double border-black border-4 left-[1200px] top-[2100px] w-auto h-auto pt-3 pl-5 pr-5 '>
          <div className='-left-0 rounded-lg absolute border-solid border-black border-4 bg-gray-400   w-full h-12'>
